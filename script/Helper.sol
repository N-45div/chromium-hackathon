...
contract Helper {
    ...
    // BlockChainIDs
    uint256 constant BlockChainIDEthereumSepolia = 11155111; // Sepolia Testnet Chain ID
    ...
    // price feed addresses (maybe change by chainlink, should check)
    // https://sepolia.etherscan.io/address/0x694AA1769357215DE4FAC081bf1f309aDC325306
    address constant ethUsdPriceFeedEthereumSepolia = 0x694AA1769357215DE4FAC081bf1f309aDC325306;
    address constant usdCusdPriceFeedEthereumSepolia = 0xA2F78ab2355fe2f984D808B5CeE7FD0A93D5270E;

    constructor() {
        networks[BlockChainIDEthereumSepolia] = "Ethereum Sepolia";
    ...
    {
        if (blockChainID == BlockChainIDEthereumSepolia) {
            return (ethUsdPriceFeedEthereumSepolia, usdCusdPriceFeedEthereumSepolia);
        }
    }
        ...
        returns (address router, address linkToken, address wrappedNative, uint64 chainId)
    {
        ...
        } else if (blockChainID == BlockChainIDAvalancheFuji) {
